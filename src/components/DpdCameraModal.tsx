        ...
        <div className="relative flex-1 min-h-[280px] sm:min-h-[320px] bg-black flex items-center justify-center overflow-hidden">
          ...
          {!isCameraActive && !capturedImage && (
            <div className="flex flex-col items-center justify-center p-6 text-center max-w-sm">
              <div className="w-14 h-14 rounded-2xl bg-cyan-500/10 border border-cyan-400/30 flex items-center justify-center text-cyan-400 mb-3">
                <span className="material-symbols-outlined text-[32px]">science</span>
              </div>
              <h4 className="font-hud font-bold text-white text-[14px]">
                Cámara WebRTC o Muestra Fotográfica
              </h4>
              <p className="text-[11.5px] text-cyan-200/80 mt-1 mb-4 leading-relaxed">
                {errorMessage ||
                  'Enfoca el tubo de ensayo con reactivo DPD-1 o sube una fotografía para calibrar el tono rosado.'}
              </p>
              <div className="flex gap-2.5">
                <button
                  onClick={startCamera}
                  className="px-4 py-2 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-white font-hud text-[11px] font-bold uppercase transition-all cursor-pointer shadow-sm active:scale-95"
                >
                  Reintentar Cámara
                </button>
                <button
                  onClick={() => fileInputRef.current?.click()}
                  className="px-4 py-2 rounded-xl bg-white/10 hover:bg-white/20 border border-cyan-400/30 text-cyan-200 font-hud text-[11px] font-bold uppercase transition-all cursor-pointer active:scale-95"
                >
                  Subir Foto
                </button>
                <input
